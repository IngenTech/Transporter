...
public class AddBranchActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        stateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                ArrayAdapter<String> city_adapter = new ArrayAdapter<String>(AddBranchActivity.this, android.R.layout.simple_spinner_item, cityNameArray);
               ...
               /* if (selectedCityId != null && selectedCityId.length() > 0) {
                    if (cityListCursor.moveToFirst()) {
                        for (int i = 0; i < cityListCursor.getCount(); i++) {
                            if (cityListCursor.getString(cityListCursor.getColumnIndex(DBAdapter.CITY_ID)).equals(selectedCityId)) {
    ...
    private void addBranchMethod() {
        StringRequest viewDocRequest = new StringRequest(Request.Method.POST, MyUtility.URL.ADD_BRANCH_API,
