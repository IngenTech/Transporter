...
public class DateTimePicker extends RelativeLayout implements View.OnClickListener, OnDateChangedListener, OnTimeChangedListener {
    ...
    public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
        ...
        System.out.println("DateTimePicker : " + year + "/" + monthOfYear + "/" + dayOfMonth );
    }
    ...
    public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
        ...
        System.out.println("DateTimePicker : " + mCalendar.get(Calendar.YEAR) + "/" + mCalendar.get(Calendar.MONTH) + "/" + mCalendar.get(Calendar.DAY_OF_MONTH) + " " + hourOfDay + ":" + minute + ":" + mCalendar.get(Calendar.SECOND));
    }
    ...
    public int get(final int field) {
        ...
        int houre = timePicker.getCurrentHour();
        int minute = timePicker.getCurrentMinute();
        mCalendar.set(Calendar.HOUR_OF_DAY, houre);
    ...
    public void setIs24hrView(boolean is24hrView) {
        timePicker.setIs24HourView(is24hrView);
    }
