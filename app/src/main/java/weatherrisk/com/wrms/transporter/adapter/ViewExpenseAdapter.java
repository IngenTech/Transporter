...
public class ViewExpenseAdapter  extends RecyclerView.Adapter<ViewExpenseAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            amount = (TextView) v.findViewById(R.id.expenseAmount);
            detail = (TextView) v.findViewById(R.id.expenseDetail);
            billdate = (TextView) v.findViewById(R.id.expenseBillDate);
            paidBy = (TextView) v.findViewById(R.id.expensePaidBy);

            billImage = (ImageView) v.findViewById(R.id.expense_image);
    ...
    public ViewExpenseAdapter(Context con,ArrayList<ExpenseBean> myDataset) {
        mDataset = myDataset;
        mContext = con;
