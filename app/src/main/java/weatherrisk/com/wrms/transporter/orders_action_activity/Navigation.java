...
public class Navigation extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        userID = prefs.getString(AppController.PREFERENCE_USERNAME, "");
                            ...
                            try {
                                ...
                                if (jsonObject.has("Status") && jsonObject.getString("Status").equalsIgnoreCase("1")) {
                                    if (jsonObject.get("Result").equals("Success")) {
                                        ...
                                        IconGenerator iconFactory = new IconGenerator(Navigation.this);
...
//                                                        System.out.println("VehicleListLength : "+vehiclesLiveArray.size());
                                        ...
                                        IconGenerator tc = new IconGenerator(Navigation.this);
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                if (vehicleNo != null && vehicleNo.trim().length() > 0) {
                    for (LiveData liveData : vehiclesLiveArray) {
                        ...
                        InfoWindowAdapter adapter = showDialog(Gravity.BOTTOM, false, data);
