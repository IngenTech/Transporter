...
//    http://android-coding.blogspot.in/2011/11/pass-data-from-service-to-activity.html
    ...
    public LiveData(double lat, double lon, String imei, String vehicleNo, String deviceDateTime, String speed, String dayMaxSpeed, String dayMAxSpeedTime, String haltTime, String runningStatus, String address, String sensorInfo, ArrayList<LatLng> allPoints) {
