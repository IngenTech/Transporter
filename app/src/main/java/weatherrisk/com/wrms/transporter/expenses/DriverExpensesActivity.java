...
import weatherrisk.com.wrms.transporter.vehicalDocument.ViewVehicalAdapter;

/**
 * Created by Admin on 24-04-2017.
 */
public class DriverExpensesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(DriverExpensesActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_expense) {
            ...
            Intent intent = new Intent(getApplicationContext(), AddDriverExpenseActivity.class);
    ...
    private void driverExpenseList() {
        StringRequest viewDocRequest = new StringRequest(Request.Method.POST, MyUtility.URL.DRIVER_EXPENSE_LIST,
                        ...
                        try {
                            ...
                            if (jsonObject.has("Status")&&(jsonObject.getString("Status").equalsIgnoreCase("1"))) {
                                ...
                                if (jsonObject.get("Result").equals("Success")) {
                                    ...
                                    JSONArray jsonArray = jsonObject.getJSONArray("DriverExpenseList");

                                    for (int i =0 ; i<jsonArray.length();i++){
                                        JSONObject jObject = jsonArray.getJSONObject(i);
                                        ExpenseBean bean = new ExpenseBean();
                                        bean.setId(jObject.getString("driver_id"));
                            ...
                            if (expenseList.size()>0) {
                                ...
                                ExpensesAdapter adapter = new ExpensesAdapter(DriverExpensesActivity.this,expenseList);
